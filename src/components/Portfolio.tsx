            ...
            {filterOptions.map((option) => {
              ...
              return (
                <button
                  ...
                  className={`group flex items-center space-x-2 px-6 py-3 rounded-xl font-medium transition-all duration-300 ${filter === option.value
              ...
              <div className="relative bg-slate-800 rounded-3xl overflow-hidden border border-slate-700 group-hover:border-purple-500 transition-all duration-500 transform group-hover:scale-105">
                ...
                <div className="relative h-64 overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4">
                    <span className={`px-4 py-2 rounded-full text-xs font-bold uppercase tracking-wider ${project.category === 'app'
